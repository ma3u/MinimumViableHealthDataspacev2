    ...
    <div className="max-w-3xl mx-auto px-6 py-10">
      ...
      <div className="mb-6 rounded-lg border border-blue-700 bg-blue-900/20 p-3 flex items-start gap-2">
        ...
        <div className="text-xs text-blue-300">
          <strong>Your data rights:</strong> You have the right to access (GDPR
          Art. 15), portability (Art. 20), rectification (Art. 16), and erasure
          (Art. 17) of your health data. Under EHDS Art. 3, you can access your
          EHR through any EU national contact point.
        </div>
      </div>
            ...
            >
              {patients.map((p) => (
                <option key={p.id} value={p.id}>
                  {p.name} — {p.gender}, born {p.birthDate} ({p.conditionCount}{" "}
                  conditions)
                </option>
              ))}
            </select>
