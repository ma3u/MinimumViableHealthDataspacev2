...
| `ehds-operating-model-primary.svg`     | The same question for **primary use**, Chapter II: who operates the services that make one record follow the citizen. Deliberately wide, 2.3:1, so it fills a slide instead of occupying half of one.                                                                                                            |
