...
| `ehds-operating-model-wide.svg`        | The **slide version**: six lessons from the Catena-X operating model, each against the article of the Regulation it lands on. Not a layer diagram, a transfer. The file above is the reference version and keeps the layered model.                                                                              |
