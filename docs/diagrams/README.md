...
| `ehds-operating-model-wide.svg`        | The same secondary-use model at 2.3:1, for slides. Full slide width instead of half. Same content as the file above, wrapped to a wider column, so the two must be kept in step.                                                                                                                                 |
