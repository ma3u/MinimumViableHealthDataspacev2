...
| ---------------------------------------------------------------- | -----: | ------------------------------------------------------------------------------------------------------------------------------------- |
| [`spain-ehds-5-slides.pptx`](spain-ehds-5-slides.pptx)           |  **5** | A short slot, or leaving something behind. Problem, what exists, the operating model, what it takes, the ask.                         |
| [`spain-ehds-ministry-deck.pptx`](spain-ehds-ministry-deck.pptx) | **24** | The full story: personas, the federated architecture, integration, outcomes, roadmap, and the five closing slides on who operates it. |
