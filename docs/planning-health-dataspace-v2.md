...
- [Planning: Health Dataspace v2](#planning-health-dataspace-v2)
  ...
  - [Implementation Roadmap](#implementation-roadmap)
    ...
    - [Phase 24: ODRL Policy Enforcement, Federated Search \& GraphRAG](#phase-24-odrl-policy-enforcement-federated-search--graphrag)
      - [24a: API Route Authentication Hardening](#24a-api-route-authentication-hardening)
      - [24b: ODRL Policy Evaluation Engine](#24b-odrl-policy-evaluation-engine)
      - [24c: Query-Time ODRL Enforcement in NLQ](#24c-query-time-odrl-enforcement-in-nlq)
      - [24d: Federated Search with Policy-Scoped SPE Fan-Out](#24d-federated-search-with-policy-scoped-spe-fan-out)
      - [24e: GraphRAG — Vector Embeddings for Semantic Query](#24e-graphrag--vector-embeddings-for-semantic-query)
      - [24f: Query Page Redesign — Visual Query Builder](#24f-query-page-redesign--visual-query-builder)
      - [24g: Audit Trail \& Compliance Logging](#24g-audit-trail--compliance-logging)
      - [Phase 24 Test Plan — 120 Test Cases](#phase-24-test-plan--120-test-cases)
