...
Sources: `docs/health-dataspace-graph-schema.md`, `.github/instructions/api-conventions.instructions.md`
...
Mirror of `.claude/skills/compliance-layer/SKILL.md` (Claude Code). Change both together.
